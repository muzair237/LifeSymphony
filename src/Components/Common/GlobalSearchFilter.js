...
const ContactsFilter = ({
  ...
  const handleChangeCategory2 = (selectedOption) => {
    setSelectedCategory2(selectedOption);
  };

  const handleChangeCategory3 = (selectedOption) => {
    setSelectedCategory3(selectedOption);
  };

  const handleChangeCategory4 = (selectedOption) => {
      ...
      >
        ...
        <div>
          <Select
            ...
            onBlur={() => handleChangeCategory2(selectedCategory2)}
            options={customValues}
            input={<OutlinedInput id="select-multiple-chip" label="Chip" />}
            renderValue={(selected) => (
              <Box sx={{ display: "flex", flexWrap: "wrap", gap: 0.5 }}>
      ...
      >
        ...
        <div>
          <Select
            ...
            onBlur={() => handleChangeCategory3(selectedCategory3)}
            options={customValues}
            input={<OutlinedInput id="select-multiple-chip" label="Chip" />}
            renderValue={(selected) => (
              <Box sx={{ display: "flex", flexWrap: "wrap", gap: 0.5 }}>
      ...
      >
        ...
        <div>
          <Select
            ...
            onBlur={() => handleChangeCategory4(selectedCategory4)}
            options={customValues}
            input={<OutlinedInput id="select-multiple-chip" label="Chip" />}
            renderValue={(selected) => (
              <Box sx={{ display: "flex", flexWrap: "wrap", gap: 0.5 }}>
